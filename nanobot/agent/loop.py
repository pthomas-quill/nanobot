...
if TYPE_CHECKING:
    from nanobot.config.schema import ChannelsConfig, ExecToolConfig, WebSearchConfig, GOGToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from nanobot.config.schema import ExecToolConfig, WebSearchConfig,GOGToolConfig
    ...
    async def _process_message(
        ...
        if cmd.startswith("/think"):
            ...
            if len(parts) == 1:
                current = self.provider.generation.reasoning_effort or "default"
                return OutboundMessage(channel=msg.channel, chat_id=msg.chat_id,
            ...
            self.provider.generation.reasoning_effort = None if level == "default" else level
            return OutboundMessage(channel=msg.channel, chat_id=msg.chat_id,
